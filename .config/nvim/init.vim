...
let &wildoptions = 'pum'
let &pumblend=0
let &wildignore = '*.o,*.obj,*~,*.class'
let &wildignore .= '*/.git'
let &wildignore .= '*.swp,*.tmp'
let &wildignore .= '*.mp3,*.mp4,*mkv'
let &wildignore .= '*.bmp,*.gif,*ico,*.jpg,*.png'
...
let &cinoptions = 'g0,l1,i0,t0,(4,N-s'
let &shortmess = 'filmnxrtToO'
let &synmaxcol = 200
let &updatetime = 250
let &virtualedit = 'block'
let &viewoptions = 'folds,cursor'
let &formatoptions = 'tcqjro'

let &diffopt = 'internal,'
let &diffopt .= 'filler,'
let &diffopt .= 'closeoff,'
let &diffopt .= 'iwhiteall,'
let &diffopt .= 'algorithm:patience,indent-heuristic,'
...
let &softtabstop = 2
let &shiftwidth = 2
let [&tabstop,&softtabstop,&shiftwidth] = repeat([2],3)
